        ...
        <div class="modal-body">
            ...
            <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="alamat" name="alamat 2" placeholder="Input Address 2">
                </div>
              </div>
              <div class="mb-3 row">
                <label for="telepon" class="col-sm-3 col-form-label"> Phone Number <span style="color:red;">*</span></label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="telepon" name="telepon" placeholder="Input Phone Number">
                </div>
              </div>
              <div class="mb-3 row">
              ...
              <p class="p-0 m-auto text-center p-2" style="font-size: 12px">Jika belum mempunyai akun silahkan Register sekarang .. !</p>
