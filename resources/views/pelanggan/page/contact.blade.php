...
@section('content')
   <div class="row mt-4 align-items-center">
    ...
    <div class="col-md-6">
        <img src="{{asset('assets/images/profil-img.png')}}" style="width:80% " alt="">
    </div>
   </div>
   ...
   <h4 class="text-center mt-md-2">Contact Us</h4>
   <hr class="mb-5">
   <div class="row mb-md-5">
    ...
    <div class="col-md-7">
       <div class="card">
        ...
        <div class="card-body">
            <p class="p-0 mb-5 text-lg-center">Masukan kritik dan saran anda kepada kami agar kami dapat memberikan
