 ...
 margin: 0;
   ...
   <div class="card mb-3">
      <div class="card-body d-flex gap-4">
         <img src="{{asset('assets/images/telur.png') }}" alt="">
         <div class="desc w-100">
            <p style="font-size: 24px; font-weight:700;">Telur Ayam</p>
            <input type="number" class="form-control border-0 fs-1" id="harga" value="27000">
            <div class="row mb-2">
               ...
               <input type="numbuer" name="qty" class="form-control w-25 text-center" id="qty" min="0" max="9999" value="1">
               <button class="rounded-end bg-secondary p-2 border border-0" id="minus" disabled>-</button>
               </div>
            </div>
           <div class="row">
            <label for="total" class="col-sm-2 col-form-label fs-5">Total</label>
           ...
           <div class="row w-50 gap-1">
            ...
            <button class="btn btn-danger col-sm-5">
               <div class="i fa fa-trash-alt"></div>
               Delete
            </button>
         </div>
      </div>
